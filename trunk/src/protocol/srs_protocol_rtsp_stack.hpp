...
protected:
    ...
    virtual srs_error_t encode_content(std::stringstream& ss);
};
...
// 10.2 DESCRIBE, @see rfc2326-1998-rtsp.pdf
// The DESCRIBE method retrieves the description of a presentation or
// media object identified by the request URL from a server. The
// description is returned in a format specified by the Accept header
// field. The list of formats supported by a server can be obtained from
// the server RTSP OPTIONS request.
